...
<body>
    ...
    <div class="center-text">
        <h1>SLOT TIME TABLE - Jerushlin Jose JB (212222240039) </h1>
    </div>
    <table>
        <tr>
...
Done by Jerushlin Jose JB (212222240039)
```

## OUTPUT

![image](https://github.com/Jerushli/slot/assets/120041243/e20466ea-9551-4a91-91aa-26f11ca99902)
